function plot_relative_auc_chr2_no_baseline(data_chr2, data_yfp, title_text)
    num_laser_levels = 5;
    ...
    % Convert means to relative percent using level 1 as the baseline
    means_chr2_relative = (means_chr2 / means_chr2(1)) * 100;
    means_yfp_relative = (means_yfp / means_yfp(1)) * 100;
    
    % Convert SEMs to relative percent using level 1 as the baseline
