function [PXX_group, f] = process_group_NE(group, group_name, PXX_group)
    PXX_yfp = cell(5, 2);
    yfp = {'584', '577', '512', '513'};
    sampling_hz = 0.0002;
...
% function [PXX_group, f, PXX_bouts] = process_group_NE(group, group_name, PXX_group)
%     sampling_hz = 0.0002;
%     dataDirectory = 'C:\Users\trb938\OneDrive - University of Copenhagen\MATLAB\chr2_yfp\Figure_4_data';
%     fsDirectory = 'C:\Users\trb938\OneDrive - University of Copenhagen\MATLAB\chr2_yfp\Traces';
% 
%     % group = {'584', '577', '512', '513'};
%     % PXX_group = cell(5, 2);
% 
%     for s = 1:length(group)
%         suffix = group{s};
