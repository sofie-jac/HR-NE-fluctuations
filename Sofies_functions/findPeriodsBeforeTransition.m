...
function pklocs_all = findPeaksBeforeTransition(SWS_before_MA_filtered, signal_fs, delta465_filt_2, sec_signal_2, skip_threshold)
   ...
   % Initialize variables for storing results
    ...
    for i = 1:size(period, 1)
        ...
        if (period(i,2) - period(i,1)) > 10 % Process only periods longer than the time window
            ...
            [pks, pklocs, w, p] = findpeaks(-NEtrace_i, 'MinPeakProminence', 1.2);
