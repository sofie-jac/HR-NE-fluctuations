function plot_correlation_memory(updated_table, arch, yfp, variable_name)
    ...
    is_arch = ismember(filtered_table.Suffix, arch_numeric);
    is_yfp = ismember(filtered_table.Suffix, yfp_numeric);
