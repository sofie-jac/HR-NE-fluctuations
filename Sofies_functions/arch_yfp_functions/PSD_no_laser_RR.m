function [psd_table, AUC_table, PeakFrequency_table, PeakPower_table] = PSD_no_laser_RR(RR_data_NREM_table, arch, yfp, min_period_dur, max_val)
    sampling_hz = 0.0002;
    fs = 64;
