...
```{r}
RR_peakPower <- read_csv("C:/Users/trb938/OneDrive - University of Copenhagen/MATLAB/chr2_yfp/combined_RR_peakPower_psd.csv")
...
m1_RR_peakPower <- lmer(formula = PeakPower ~  LaserLevel * GT + (1|Suffix), data = RR_peakPower, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m3_RR_peakPower <- lmer(formula = PeakPower ~  LaserLevel * GT + (LaserLevel|Suffix), data = RR_peakPower, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m2_RR_peakPower <- lmer(formula = PeakPower ~  LaserLevel + GT + (1|Suffix), data = RR_peakPower)
...
emm <- emmeans(m1_RR_peakPower, ~ LaserLevel * GT, pbkrtest.limit = 3737, lmerTest.limit = 3737)
...
pairwise_ci_RR_peakPower <- bootstrap_block_pairwise_contrasts(RR_peakPower, PeakPower ~ LaserLevel * GT + (1 | Suffix), "GT", "Suffix", R = 1000)
# print(pairwise_ci)
...
m1_RR_peakfreq <- lmer(formula = PeakFrequency ~  LaserLevel * GT + (1|Suffix), data = RR_peakfreq, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m3_RR_peakfreq <- lmer(formula = PeakFrequency ~  LaserLevel * GT + (LaserLevel|Suffix), data = RR_peakfreq, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m2_RR_peakfreq <- lmer(formula = PeakFrequency ~  LaserLevel + GT + (1|Suffix), data = RR_peakfreq)

anova(m1_RR_peakfreq, m2_RR_peakfreq) # M1

check_lmm_assumptions(m1_RR_peakfreq) #problems with everything

# Calculate estimated marginal means
emm <- emmeans(m1_RR_peakfreq, ~ LaserLevel * GT, pbkrtest.limit = 3737, lmerTest.limit = 3737)
...
pairwise_ci_RR_peakfreq <- bootstrap_block_pairwise_contrasts(RR_peakfreq, PeakFrequency ~ LaserLevel * GT + (1 | Suffix), "GT", "Suffix", R = 1000)
# print(pairwise_ci)
...
```{r}
m1_RR_PSD_AUC <- lmer(formula = AUC_RR ~  LaserLevel * GT + (1|Suffix), data = PSD_AUC, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m3_RR_PSD_AUC <- lmer(formula = AUC_RR ~  LaserLevel * GT + (LaserLevel|Suffix), data = PSD_AUC, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m2_RR_PSD_AUC <- lmer(formula = AUC_RR ~  LaserLevel + GT + (1|Suffix), data = PSD_AUC)
...
# Calculate estimated marginal means
emm <- emmeans(m1_RR_PSD_AUC, ~ LaserLevel * GT, pbkrtest.limit = 3737, lmerTest.limit = 3737)
...
pairwise_ci_RR_PSD_AUC <- bootstrap_block_pairwise_contrasts(PSD_AUC, AUC_RR ~ LaserLevel * GT + (1 | Suffix), "GT", "Suffix", R = 1000)
# print(pairwise_ci)
...
m1_NE_PSD_AUC <- lmer(formula = AUC_NE ~  LaserLevel * GT + (1|Suffix), data = PSD_AUC, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m3_NE_PSD_AUC <- lmer(formula = AUC_NE ~  LaserLevel * GT + (LaserLevel|Suffix), data = PSD_AUC, control = lmerControl(optimizer = "bobyqa", optCtrl = list(maxfun = 1e5)))
m2_NE_PSD_AUC <- lmer(formula = AUC_NE ~  LaserLevel + GT + (1|Suffix), data = PSD_AUC)
...
pairwise_ci_NE_PSD_AUC <- bootstrap_block_pairwise_contrasts(PSD_AUC, AUC_NE ~ LaserLevel * GT + (1 | Suffix), "GT", "Suffix", R = 1000)
# print(pairwise_ci)
